...
export const messages: Record<Locale, TranslationMessages> = {
	es: {
		...
		business: {
			...
			statActiveOffersHint:
				'Ofertas visibles ahora mismo, sobre el total publicado con tu comercio.',
			statViews: 'Vistas',
			statViewsHint:
	...
	en: {
		...
		business: {
			...
			statViews: 'Views',
			statViewsHint:
				'Detail-page views summed across all your offers. Your own visits do not count.',
			statClicks: 'Clicks',
			statClicksHint:
				'Clicks on "Go to the store" toward your site, summed across all your offers.',
			statScore: 'Score',
		...
		admin: {
			...
			affiliateMerchantHint:
				'The affiliation is approved on the spot: the merchant becomes theirs.',
	...
	fr: {
		...
		admin: {
			...
			tabClaims: 'Affiliations',
			accountsSubtitle:
				'Créez, modifiez et désactivez tous les comptes, dont ceux des entreprises.',
			claimsSubtitle:
