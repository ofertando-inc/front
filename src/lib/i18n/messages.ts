...
export const messages: Record<Locale, TranslationMessages> = {
	es: {
		...
		errors: {
			...
			'comment.cannot_reply_to_reply': 'Solo puedes responder a un comentario principal.',
	...
	en: {
		...
		errors: {
			...
			'comment.cannot_reply_to_reply': 'You can only reply to a top-level comment.',
	...
	fr: {
		...
		errors: {
			...
			'comment.cannot_reply_to_reply': 'Vous ne pouvez répondre qu’à un commentaire principal.',
