...
export interface TranslationMessages {
	...
	business: {
		...
		statActiveOffersHint: string;
		statViews: string;
		statViewsHint: string;
		statClicks: string;
		statClicksHint: string;
		statScore: string;
		statScoreHint: string;
		statComments: string;
		statCommentsHint: string;
		statReports: string;
		statReportsHint: string;
		filterAllOffers: string;
		myOffersSubtitle: string;
		myOffersFilterEmpty: string;
